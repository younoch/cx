      ...
      <v-form @reset.prevent="reset" @submit.prevent="handleSubmit(onSubmit)">
        ...
        <v-card class="mb-4 rounded-lg" outlined>
          <v-card-title class="py-2">
            <h4 class="text--text">Cover Image</h4>
          </v-card-title>
          <v-divider />
          <ImageUploader
            v-model="image"
        ...
        <v-card class="mb-0 mb-md-4 mb-lg-4 mb-xl-4 rounded-lg" outlined>
          ...
          <v-divider />
          <v-card-actions v-if="breakpoint.mdAndUp" class="justify-center">
            <v-btn
      ...
      return [
        {
          ...
          to: `/topics/${this.$route.params.slug}`,
          disabled: false,
          icon: false,
          exact: true,
        },
    ...
    async publishArticle() {
      ...
      try {
        ...
        this.$store.dispatch('crud_success', {
          ...
          path: `/topics/${this.$route.params.slug}`,
        });
        this.$vuetify.goTo(0);
      } catch (err) {
        this.loading = false;
