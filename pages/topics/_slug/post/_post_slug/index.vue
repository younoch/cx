  ...
  <div id="post">
    <v-container v-if="post" class="pt-0 px-0">
      <v-row>
        <v-col cols="12" md="12">
          <v-card outlined>
            <v-card-title class="flex-column align-start pt-2 pb-0">
              <h1 class="text-h6 cx-title line-height-26 mb-2">
                {{ post.title }}
              </h1>
            </v-card-title>
            ...
            <v-divider />
            <v-card v-if="post.image" flat class="rounded-0">
