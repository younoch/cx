          ...
          <v-row v-for="(step, i) in steps" :key="i">
              ...
              >
                ...
                >
                  ...
                  >
                    <template #activator="{ on, attrs }">
                      <div class="d-inline" v-bind="attrs" v-on="on">
                        <div :class="breakpoint.md ? 'font-16' : 'cx-title'">
                          {{ step.title }}
                        </div>
                      </div>
                    </template>
                  ...
                  <div v-else :class="breakpoint.md ? 'font-16' : 'cx-title'">
                    <p class="mb-0 text-line-clamp white--text">
                      {{ step.title }}
                    </p>
                  </div>
                  <!-- step actions -->
            ...
            <v-col cols="12" md="6" :lg="stepDialog ? '3' : '6'" sm="6">
              <draggable
                ...
                tag="div"
                class="row answers-draggable mt-n1"
                filter=".add-answer"
                ghost-class="sortable-ghost"
                chosen-class="sortable-chosen"
                :disabled="user.id !== map.user_id"
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    <v-card-actions>
                      ...
                      {{ answer.meta ? answer.meta.length : '0' }}&nbsp;&nbsp;
                ...
                <v-col
                  ...
                  cols="12"
                >
                  <v-card v-if="answerBoxOpen && stepIndex === i" outlined>
              ...
              <v-card v-if="stepBoxOpen && stepIndex === -1" outlined>
                ...
                >
                  <v-form @submit.prevent="handleSubmit(addStep)">
                    <v-card-text>
                      <p v-if="error" class="red--text caption mb-3 pl-3">
                        {{ error }}
                      </p>
                      <b-text
                        v-model="newStep.title"
      ...
      >
        <v-card v-if="activeStep">
          ...
          <v-card-text class="pa-3">
            ...
            <!-- comments -->
            <transition v-if="!isCreateAnswer" name="fade">
              <comment-list
...
export default {
  ...
  methods: {
    ...
    // open answer dialog for Create new one
